...
def start_training(char_name, char_class):
    ...
    print('''Введи одну из команд: attack — чтобы атаковать противника, defence — чтобы блокировать
...
def choice_char_class():
    ...
    while approve_choice != 'y':
        char_class = input('''Введи название персонажа,
         за которого хочешь играть: Воитель — warrior, Маг — mage, Лекарь — healer: ''')
        if char_class == 'warrior':
        ...
        approve_choice = input(
            ...
            ' выбор, или любую другую кнопку, чтобы выбрать другого персонажа ''').lower()
    return char_class
